 ...
 * <p>This interface is used by bean factories to delegate bean instantiation.
 * Different implementations may use different approaches to create bean instances.
 *
 * @author pythongong
...
public interface InstantiationStrategy {
    ...
    /**
     * Create a new instance of a bean using the specified constructor and arguments.
     *
